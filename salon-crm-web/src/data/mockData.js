export const mockData = {
  ...
  appointments: [
    ...
    { id:"a2", stylistId:"s2", clientName:"Bob Williams",   service:"Color Treatment",    start:"2023-10-27T10:30:00", end:"2023-10-27T11:30:00", status:"pending"   },
    { id:"a3", stylistId:"s1", clientName:"Carol Davis",    service:"Blowout",            start:"2023-10-27T11:00:00", end:"2023-10-27T11:30:00", status:"confirmed" },
    { id:"a4", stylistId:"s3", clientName:"David Brown",    service:"Beard Trim",         start:"2023-10-27T09:30:00", end:"2023-10-27T10:00:00", status:"confirmed" },
    ...
    { id:"a6", stylistId:"s4", clientName:"Frank Moore",    service:"Shampoo & Set",      start:"2023-10-27T14:00:00", end:"2023-10-27T14:30:00", status:"pending"   },
    ...
    { id:"a8", stylistId:"s4", clientName:"Henry Clark",    service:"Men's Cut",          start:"2023-10-27T10:00:00", end:"2023-10-27T10:30:00", status:"confirmed" },
...
export const generateTimeSlots = (openTime, closeTime, intervalMin) => {
  ...
  for (let m = start; m < end; m += intervalMin) {
    ...
    slots.push({ minutes: m, label: `${dh}:${min.toString().padStart(2,"0")} ${ampm}`, key: `${h}:${min.toString().padStart(2,"0")}` });
  }
  return slots;
};
